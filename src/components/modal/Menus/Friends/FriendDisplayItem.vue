    ...
    <span>
      <div class="name">
        ...
        <div class="dots">
          ...
          <div class="friend_dots">
            <img
              src="data:image/png;base64,"
            />
          </div>
        </div>
      </div>
